...
const ProjectCard: React.FC<ProjectProps> = ({ name, image, desc, url }: ProjectProps) => {
  return (
    <div className="p-2 max-w-sm m-2 h-96  rounded-xl shadow-md transition hover:-translate-y-1 duration-100 transform border border-gray-100 dark:border-gray-700 hover:shadow-2xl pt-4">
