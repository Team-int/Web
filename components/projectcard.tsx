...
const ProjectCard: React.FC<ProjectProps> = ({ name, image, desc, url }: ProjectProps) => {
  return (
    <div className="p-2 max-w-sm m-2 h-80  rounded-xl shadow-lg transition hover:-translate-y-1 duration-200 transform border border-gray-100 dark:border-gray-400 hover:shadow-2xl pt-4">
